...
# CLASS DEFINITIONS                                                            #
################################################################################
define (class _difpr_D 'D-' D+ )
#forget class _difpr_D

define (class _difpr_DP1 N883071 N883057 )
...
# PAIR DEFINITIONS                                                             #
################################################################################
define (pair (nets N883071 N883057 ))
#forget pair (nets N883071 N883057)

define (pair (nets 'D-' D+ ))
...
set bbvia_area on
rule PCB (clearance 5 (type nhole_wire))
set nhole_wire off
